   ...
   do                 
      ...
      do                         
        ...
        time $HADOOP_PATH/hadoop jar $HADOOP_MR/hadoop-examples.jar teragen \
                     ...
                     100000000 hdfs://172.16.7.10/results/tg-10GB-${i}-${j}-${k} 1>tera_${i}_${j}_${k}.out 2>tera_${i}_${j}_${k}.err                       
       ...
       time $HADOOP_PATH/hadoop jar $HADOOP_MR/hadoop-examples.jar terasort \
	             ...
	             hdfs://172.16.7.10/results/tg-10GB-${i}-${j}-${k}  \
                     hdfs://172.16.7.10/results/ts-10GB-${i}-${j}-${k} 1>>tera_${i}_${j}_${k}.out 2>>tera_${i}_${j}_${k}.err                         

        $HADOOP_PATH/hadoop fs -rm -r -skipTrash /results/tg-10GB-${i}-${j}-${k}                         
        $HADOOP_PATH/hadoop fs -rm -r -skipTrash /results/ts-10GB-${i}-${j}-${k}   
		
		echo run MAP-$i-REDUCE-$j-MEM-$k-$MAP_MB-$RED_MB
